...
document.getElementById('playSnake').addEventListener('click', startSnake);
document.getElementById('playPong').addEventListener('click', startPong);

const buttons = document.querySelectorAll('#controls [data-key]');
